defmodule PmetricsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PmetricsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PmetricsWeb.Gettext, "errors", msg, opts)
    end
  end
