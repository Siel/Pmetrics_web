defmodule PmetricsWeb.Router do
  use PmetricsWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {PmetricsWeb.Layouts, :root}
  ...
  if Application.compile_env(:pmetrics, :dev_routes) do
  ...
  scope "/", PmetricsWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{PmetricsWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", PmetricsWeb do
    ...
    live_session :current_user,
      on_mount: [{PmetricsWeb.UserAuth, :mount_current_user}] do
